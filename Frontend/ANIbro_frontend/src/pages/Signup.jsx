  ...
  return (
    <div className='min-h-screen min-w-full bg-black text-color selection:bg-amber-500/60 flex justify-center items-center'>
      <div className='w-[90%] max-w-[1343px] h-200 relative overflow-hidden rounded-lg flex 2xl:bg-gray-300 xl:bg-[#2f628f]'>
        <img src='https://res.cloudinary.com/dkfddgsc0/image/upload/v1769861579/one_piece_extended_xf5sin.jpg' alt="SignUp_pic" className='absolute remove-on-small-screen 2xl:-top-[9vw] w-[44%] right-0 -bottom-[1vw] brightness-85 blur-[1px]'/>
        ...
        <img src='https://res.cloudinary.com/dkfddgsc0/image/upload/v1769861596/one_piece_transparent_kvxpf6.png' alt="SignUp_pic" className='absolute z-50  2xl:-top-[9vw] -bottom-[1vw] right-0 brightness-105 drop-shadow-lg drop-shadow-black'/>
        </div>
      </div>
    </div>
  )
